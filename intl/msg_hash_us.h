...
MSG_HASH(
   ...
   "Save State to the selected Slot"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Load State from the selected Slot"
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Insert current Disc and close tray"
   )
MSG_HASH(
